"""
Django settings for plumbing_site project.
...
SECRET_KEY = 'django-insecure-k%g=ieiu0#0(6t+6gmhyye^mgw%1360xtza=&wp5cwqs^^5q^x'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'info@pmpservices.co.uk'
EMAIL_HOST_PASSWORD = 'nyvy bfeq rodg pvhg'  # Use App Password if Gmail
